...
import paperlessImage from '../assets/paperless.png';
import securityImage from '../assets/security.png';
import integrationImage from '../assets/seamless.png';
import customizableImage from '../assets/customize.png';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
            Partnering with Click To Secure – Your Key to Success
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover the benefits of joining forces with the leader in insurance technology
          </p>
        </div>
        ...
        {features.map((feature, index) => (
          <div 
            key={index} 
            className={`feature-block mb-24 last:mb-0 flex flex-wrap items-center ${
              index % 2 !== 0 ? 'flex-row-reverse' : ''
            }`}
          >
            <div className="w-full lg:w-1/2 mb-8 lg:mb-0 p-4">
              <div className={`text-left ${index % 2 !== 0 ? 'lg:text-right lg:pl-12' : 'lg:pr-12'}`}>
                <h3 className="text-2xl font-bold mb-4 text-gray-800">{feature.title}</h3>
                <p className="text-gray-600 mb-6">{feature.description}</p>
                <button className="inline-flex items-center text-white bg-blue-500 hover:bg-blue-600 px-6 py-3 rounded-full font-medium transition-all duration-300 transform hover:-translate-y-1">
                  Request a demo
